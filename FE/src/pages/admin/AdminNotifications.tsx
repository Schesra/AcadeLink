    ...
    return (
      <div className="space-y-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="bg-card rounded-xl p-4 flex gap-3 animate-pulse border border-border">
    ...
    <div className="max-w-2xl mx-auto">
      ...
      {notifications.length === 0 ? (
        <div className="bg-card rounded-xl border border-border p-16 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">Các thông báo sẽ xuất hiện tại đây</p>
        </div>
      ) : (
